...
# 更新计划
1. 如果同时多点了，打开两个程序可能会冲突。：只允许同时存在一个程序
2. ✅️拉起线程每60s保存一次字典。
...
10. ❌️有时鼠标滚轮滚动过快会导致内部大量 widgets 重绘，进而引发程序崩溃。
如果数据量大、滚动多，建议改用：
...
17. 自动获取最新版本
18. ✅️增加一个安装程序
19. ✅️引进了日志功能--程序崩溃自动生成日志
20. ✅️增加查看历史数据功能
21. 操作提示
22. 用户自定义过滤指定窗口名
23. ✅️禁止主窗口拉伸
24. ✅️安装包程序安装到C盘默认目录会有bug
25. ✅️安装包程序生成的快捷方式存在点击后快捷方式链接不到源程序的问题
26. ✅️在开机自启上面再增加一个“已打开”和“已关闭”的Label标签提示
...
## 核心文档
1. **[项目总体概述](./docs/项目总体概述.md)** - 项目架构和技术选型
2. **[功能需求文档](./docs/功能需求文档.md)** - 详细功能需求分析
3. **[前后端API文档](./docs/前后端API文档.md)** - RESTful API接口规范
4. **[数据库设计文档](./docs/数据库设计文档.md)** - 数据库设计和优化方案

## 文档索引
查看 [docs/README.md](./docs/README.md) 获取完整的文档导航和更新记录。

## 开发计划
基于文档规划，后续开发将分为三个阶段：
1. **第一阶段**：完善现有桌面客户端
2. **第二阶段**：开发Web管理平台（SpringBoot + Vue3）
3. **第三阶段**：实现高级功能和多设备同步
